...
/opt/my-scripts/1_ca_generate_secrets.sh
/opt/my-scripts/2_change_IP_and_SUBNET_for_vpn_server_client.sh
/opt/my-scripts/3_copy_secrets_to_vpn.sh
/opt/my-scripts/4_restart_vpn.sh
/opt/my-scripts/8_create_clients_crt_key_for_prometheus.sh
